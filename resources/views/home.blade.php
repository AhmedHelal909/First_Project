				...
				<div class="breadcrumb-header justify-content-between">
					...
					<div class="main-dashboard-header-right">
						...
						<div>
							...
							<h5>${{number_format(\App\Models\invoices::sum('Total'),3)}}</h5>
						</div>
					</div>
				</div>
				<!-- /breadcrumb -->
						...
						<div class="card overflow-hidden sales-card bg-danger-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">${{number_format(\App\Models\invoices::where('Status','غير مدفوعة')->sum('Total'),3)}}</h4>
											<p class="mb-0 tx-12 text-white op-7">{{\App\Models\invoices::where('Value_Status','2')->count()}}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7">{{round(number_format((\App\Models\invoices::where('Value_Status','2')->count()/\App\Models\invoices::count())*100,2))}}%</span>
										</span>
									</div>
								</div>
							</div>
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
											<span class="text-white op-7">{{round(number_format((\App\Models\invoices::where('Value_Status','1')->count()/\App\Models\invoices::count())*100,2))}}%</span>
										</span>
									</div>
								</div>
							</div>
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7">{{round(number_format((\App\Models\invoices::where('Value_Status','3')->count()/\App\Models\invoices::count())*100,2))}}%</span>
										</span>
									</div>
								</div>
							</div>
				...
				<div class="row row-sm">
					...
					<div class="col-lg-12 col-xl-5">
						<div class="card card-dashboard-map-one">
							<label class="main-content-label" style="margin-bottom: 20px;">نسبة احصائية الفواتير</label>
