                                            ...
                                            <div class="card card-statistics">
                                                ...
                                                <div class="table-responsive mt-15">
                                                    <table class="table center-aligned-table mb-0 table table-hover"
                                                        ...
                                                        <tbody>
                                                            <?php $i = 0; ?>
                                                                @foreach ( $attachments as $attaachment )
                                                                    
                                                                <tr>
                                                                    <td>{{ ++$i }}</td>
                                                                    <td>{{ $attaachment->file_name }}</td>
                                                                    <td>{{ $attaachment->Created_by }}</td>
                                                                    <td>{{ $attaachment->created_at }}</td>
                                                                    <td colspan="2">

                                                                        <a class="btn btn-outline-success btn-sm"
                                                                            href="{{ url('open_file')}}/{{ $invoices->invoice_number }}/{{ $attaachment->file_name }}"
                                                                            role="button"><i class="fas fa-eye"></i>&nbsp;
                                                                            عرض</a>

                                                                        <a class="btn btn-outline-info btn-sm"
                                                                        href="{{ url('download') }}/{{ $invoices->invoice_number }}/{{ $attaachment->file_name }}"
                                                                            role="button"><i
                                                                            ...
                                                                            <button class="btn btn-outline-danger btn-sm"
                                                                                data-toggle="modal"
                                                                                data-file_name="{{ $attaachment->file_name }}"
                                                                                data-invoice_number="{{ $attaachment->invoice_number }}"
                                                                                data-id_file="{{ $attaachment->id }}"
